    ...
    public function edit($id)
        ...
        ORDER BY serial_numbers.tower_id, serial_numbers.date DESC;
            ...
            ";
                ...
                // if ($serialNumber && $serialNumber->date) {
                //     $gregorianDate = \Carbon\Carbon::parse($serialNumber->date);
                //     $jalaliDate = \Morilog\Jalali\Jalalian::fromCarbon($gregorianDate);
            
                //     // Manually construct AM/PM format
                //     $serialNumber->date = $jalaliDate->format('Y/m/d h:i') . ' ' . ($gregorianDate->format('A') === 'AM' ? 'AM' : 'PM');
                // }
                // dd($serialNumber->date);
                // Return the view with the results
                return view('meter_reading.form', [
                    'towers' => $towers,
                    'finalResults' => $flatResults,
