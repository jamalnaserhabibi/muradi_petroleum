...
@section('content')
    ...
    @endif
                                <div class="card-body mt-3">
                                    ...
                                    <!-- Description Input -->
                                    <textarea  class="form-control form-control" name="description" id="expenseDescription" rows="4" placeholder="Description" required>{{ old('description', $expense->description ?? '') }}</textarea>
