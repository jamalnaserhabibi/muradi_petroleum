                                    ...
                                    <div class="card tower-card">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                <a href="{{ route('singletowereadings', ['tower_id' => $towerData['info']['tower_id']]) }}"
                                                    style="color: inherit;">
                                                    {{ $towerData['info']['tower_serial'] }} -
                                                    {{ $towerData['info']['product_name'] }}
                                                </a>
                                            </h3>
                                        </div>
                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-start">
                                                                ...
                                                                <div class="action-btns">
                                                                    ...
                                                                    @if (Auth::user()->usertype == 'admin')
                                                                        <form
                                                                            action="{{ route('deleteserialnumber', $row['id']) }}"
