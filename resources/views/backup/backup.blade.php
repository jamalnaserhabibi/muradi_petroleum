                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!-- Backup Button -->
                                <a href="{{ route('getbackup') }}" class="btn btn-primary">Create Backup</a>
                    
                                <!-- Restore Form -->
                                <form action="{{ route('restore') }}" method="POST" enctype="multipart/form-data" class="mt-3">
                                    @csrf
                                    <input type="file" name="backup" class="form-control mb-2">
